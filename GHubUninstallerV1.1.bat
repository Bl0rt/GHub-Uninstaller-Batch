...
Echo.
Echo.
Echo Does not currently work! If you would like to automatically download the latest version of GHub please enter "5" (Needs WinGet)
Echo.
Echo.
...
Echo.
Echo If you have WinGet installed please. 
Echo.
Echo.
Echo UPDATE Currently Logitech does not support this feature for GHub. 
